...
class Tournament(TournamentController, Player):
	def __init__(self):
		# self.name: str = self.get_information_user("Nom du tournoi")
		# self.place: str = self.get_information_user("Lieu du tournoi")
		# self.date_start: str = self.get_information_user("date de début du tournoi", data_type="day_date")
		# self.date_end: str = self.get_information_user("date de fin du tournoi", data_type="day_date")
		# self.description: str = self.get_information_user("description du tournoi")
		# self.number_of_rounds: int = self.get_information_user("nombre de rounds", data_type="integer")
